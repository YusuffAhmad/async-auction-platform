    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuctionItemDetails", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BidderInfo", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HighestBidderId = table.Column<Guid>(type: "uuid", nullable: false),
                    WinningBidAmount = table.Column<decimal>(type: "numeric", nullable: false),
                    PaymentTermsId = table.Column<Guid>(type: "uuid", nullable: false),
                    AuctionCompletionDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ...
                    RefundPolicy = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Invoices", x => x.InvoiceId);
                    table.ForeignKey(
                        name: "FK_Invoices_AuctionItemDetails_ItemDetailsId",
                        column: x => x.ItemDetailsId,
                        principalTable: "AuctionItemDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Invoices_BidderInfo_HighestBidderId",
                        column: x => x.HighestBidderId,
                        principalTable: "BidderInfo",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Invoices_HighestBidderId",
                table: "Invoices",
                column: "HighestBidderId");

            migrationBuilder.CreateIndex(
                name: "IX_Invoices_ItemDetailsId",
                table: "Invoices",
